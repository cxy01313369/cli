...
| ---------------------------- | -------------- | ------------------------------------------------------------------------------------------- |
| `bl monitor delivery enable` | Console        | Activate monitoring delivery: initializes the CMS service and dedicated Prometheus instance |
...
| **Description**    | Activate monitoring delivery: initializes the CMS service and dedicated Prometheus instance |
...
| ------------------------------ | ------ | -------- | ------------------------------------------------------------------ |
| `--no-wait`                    | switch | no       | Submit the activation request and return without waiting for Ready |
...
| `--step <seconds>`                                                  | number | no       | Data point interval in seconds (default: auto by time range) |
| `--console-region <region>`                                         | string | no       | Console gateway region (e.g. cn-beijing, ap-southeast-1)     |
| `--console-site <site>`                                             | string | no       | Console site: domestic, international                        |
| `--console-switch-agent <uid>`                                      | number | no       | Switch agent UID for delegated access                        |
| `--workspace-id <id>`                                               | string | no       | Workspace ID (env: BAILIAN_WORKSPACE_ID)                     |
...
```bash
bl monitor overview --call-source Offline --days 1
```
