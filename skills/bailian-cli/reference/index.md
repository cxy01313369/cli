...
| `bl log count`                   | Console        | Count model call logs in a time range (useful before exporting)                                  | [log.md](log.md)               |
| `bl log disable`                 | Console        | Disable inference log delivery for all models in the workspace                                   | [log.md](log.md)               |
| `bl log enable`                  | Console        | Enable inference log delivery to SLS (SLR authorization → SLS instance → log switch)             | [log.md](log.md)               |
| `bl log get`                     | Console        | Show a single call log with full request/response content                                        | [log.md](log.md)               |
| `bl log list`                    | Console        | Query model call logs (audit trail; use --full for request/response content)                     | [log.md](log.md)               |
| `bl log status`                  | Console        | Show model log delivery status (SLS authorization, audit / inference log)                        | [log.md](log.md)               |
...
| `bl monitor delivery enable`     | Console        | Activate monitoring delivery: initializes the CMS service and dedicated Prometheus instance      | [monitor.md](monitor.md)       |
...
| `log`        | `count`, `disable`, `enable`, `get`, `list`, `status`, `trace get`, `trace list`, `trace stats`                                                                                                                                                                                                                                                                                                                                                                                             | [log.md](log.md)               |
...
| `monitor`    | `delivery enable`, `delivery status`, `errors`, `metrics`, `models`, `overview`                                                                                                                                                                                                                                                                                                                                                                                                             | [monitor.md](monitor.md)       |
