...
export { default as logList } from "./commands/log/list.ts";
export { default as logGet } from "./commands/log/get.ts";
export { default as logCount } from "./commands/log/count.ts";
export { default as logStatus } from "./commands/log/status.ts";
export { default as logEnable } from "./commands/log/enable.ts";
export { default as logDisable } from "./commands/log/disable.ts";
